...
def reset_game():
    ...
    global stair_portal_x, stair_portal_y, floor_changed, collected_set
    player_x = 0
    player_y = 0
    player_floor = 0
    kimetsu_points = 0
...
def main():
    ...
    while running:
        ...
        if state=="intro":
            ...
            draw_text_with_outline("INFINITY CASTLE", large_font, RED, WHITE, SCREEN_WIDTH//2-large_font.size("INFINITY CASTLE")[0]//2,50,screen)
